# Generated by Django 2.0.6 on 2019-11-30 01:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('autor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lol.Autor')),
                ('categoria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lol.Categoria')),
            ],
            options={
                'verbose_name': 'Post',
